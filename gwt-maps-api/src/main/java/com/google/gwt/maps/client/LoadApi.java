...
public class LoadApi {
   ...
   */
  public static void go(Runnable onLoad, String apiKey) {
    load(onLoad, apiKey, null, null, null);
  }
   ...
   * @param apiKey - API key
   */
  public static void go(Runnable onLoad, ArrayList<LoadLibrary> loadLibraries, String apiKey) {
    load(onLoad, apiKey, loadLibraries, null, null);
  }
   ...
   */
  public static void go(Runnable onLoad, ArrayList<LoadLibrary> loadLibraries, String apiKey, Language language) {
    load(onLoad, apiKey, loadLibraries, language, null);
  }
   ...
   * @param apiKey - API key
   */
  public static void go(Runnable onLoad, LoadLibrary[] loadLibraries, String apiKey) {
    ArrayList<LoadLibrary> loadLibrariesList = new ArrayList<LoadLibrary>(Arrays.asList(loadLibraries));
    load(onLoad, apiKey, loadLibrariesList, null, null);
  }
   ...
   * @param language choose a language
   */
  public static void go(Runnable onLoad, LoadLibrary[] loadLibraries, String apiKey, Language language) {
    ArrayList<LoadLibrary> loadLibrariesList = new ArrayList<LoadLibrary>(Arrays.asList(loadLibraries));
    load(onLoad, apiKey, loadLibrariesList, language, null);
  }
   ...
   */
  public static void go(Runnable onLoad, String apiKey, String otherParams) {
    load(onLoad, apiKey, null, null, otherParams);
  }
   ...
   * @param otherParams add additional params. like "key=YOUR_API_KEY"
   */
  public static void go(Runnable onLoad, ArrayList<LoadLibrary> loadLibraries, String apiKey, String otherParams) {
    load(onLoad, apiKey, loadLibraries, null, otherParams);
  }
  ...
  public static void go(Runnable onLoad, ArrayList<LoadLibrary> loadLibraries, String apiKey, Language language,
      String otherParams) {
    load(onLoad, apiKey, loadLibraries, language, otherParams);
  }

  private static void load(Runnable onLoad, String apiKey, ArrayList<LoadLibrary> loadLibraries, Language language,
      String otherParams) {
    String op = "key=" + apiKey;
    if (otherParams != null) {
      op += "&" + otherParams;
    }
